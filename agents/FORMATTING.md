...
## 1. File Preambles (.h and .cpp)
- **Header Files (`.h`)**: Every header file must start with a filename banner followed immediately by `#pragma once`, an empty line, and header includes:
  ```cpp
  // <filename>.h -------------------------------------------------------------------------------------------------------
  #pragma once
  ...
  #include ...
  ```
  Header files do NOT use legacy `#ifndef` / `#define` / `#endif` sentinels.
- **Source Files (`.cpp`)**: Every C++ source file must start with a filename banner, an empty line, and file includes:
  ```cpp
  // <filename>.cpp -----------------------------------------------------------------------------------------------------

  #include ...
  ```
  Source files do NOT include `#pragma once`.
...
## 3. Spacing in Parentheses & Brackets

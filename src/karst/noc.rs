// src/karst/noc.rs
use	crate::karst::config::{ K_DIE_ADDR_BIT, K_HOSTS_PER_FABRIC, K_HOSTS_PER_HIND, K_INTERDIE_PORT_BASE, K_KL_PORTS_PER_HIND, K_MC_ADDR_MASK, K_MC_ADDR_SHIFT, K_MC_PORTS_PER_HIND };

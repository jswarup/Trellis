...
use	crate::crew::protocol::{ REG_NODE_ID, REG_RX_COUNT, REG_RX_DATA, REG_STATUS, REG_TX_DATA, STATUS_PEER_UP, STATUS_RX_READY, STATUS_TX_READY };
...
{
    pub fn	New( 
        layout: &mut Layout, name: &str, nodeId: u32, attachedVm: Option< &VMRunner>,
        parent: ModuleId,
    ) -> Self
    {
        let  	inDescs = [
        ...
        let  	id = layout.AddCoroModule( name, parent, &inDescs[..], &outDescs[..], move || {

...
struct Capsule[*Ts: CollectionElement](
    ...
    fn __init__(inout self, *, unsafe_uninitialized: ()):
        """Unsafely create an uninitialized Capsule.
    ...
    fn __init__[T: CollectionElement](inout self, owned value: T):
        ...
        Parameters:
            T: The type to initialize the variant to. Generally this should
                be able to be inferred from the call type, eg. `Capsule[Int, String](4)`.
    ...
    fn set[T: CollectionElement](inout self, owned value: T):
        ...
        Parameters:
            T: The new variant type. Must be one of the Capsule's type arguments.

...
impl FasciaTheme {
    ...
    pub fn palette(&self) -> ThemePalette {
        match self {
            Self::WindowsDark => ThemePalette {
                app_bg: Color::from_rgb8(32, 32, 32),
            ...
            Self::WindowsLight => ThemePalette {
                app_bg: Color::from_rgb8(243, 243, 243),
            ...
            Self::LinuxDark => ThemePalette {
                app_bg: Color::from_rgb8(36, 36, 36),
            ...
            Self::LinuxLight => ThemePalette {
                app_bg: Color::from_rgb8(250, 250, 250),
            ...
            Self::VsCodeDark => ThemePalette {
                app_bg: Color::from_rgb8(30, 30, 30),
...
impl FasciaStyle {
    pub fn menubar_container(palette: ThemePalette) -> container::Style {
        container::Style {
            background: Some(Background::Color(palette.menubar_bg)),
    ...
    pub fn toolbar_container(palette: ThemePalette) -> container::Style {
        container::Style {
            background: Some(Background::Color(palette.toolbar_bg)),
            text_color: Some(palette.text_primary),
            border: Border {
                color: palette.border_subtle,
                width: 1.0,
    ...
    pub fn activity_bar_container(palette: ThemePalette) -> container::Style {
        container::Style {
            background: Some(Background::Color(palette.activity_bar_bg)),
    ...
    pub fn tab_bar_container(palette: ThemePalette) -> container::Style {
        container::Style {
            background: Some(Background::Color(palette.tab_bar_bg)),
            text_color: Some(palette.text_primary),
            border: Border {
                color: palette.border_subtle,
                width: 1.0,
    ...
    pub fn content_container(palette: ThemePalette) -> container::Style {
        container::Style {
            background: Some(Background::Color(palette.content_bg)),
            text_color: Some(palette.text_primary),
    ...
    pub fn status_bar_container(palette: ThemePalette) -> container::Style {
        container::Style {
            background: Some(Background::Color(palette.status_bar_bg)),
...
pub fn default_system_font(theme: FasciaTheme) -> Font {
    match theme {
        FasciaTheme::WindowsDark | FasciaTheme::WindowsLight => Font {
            family: iced::font::Family::Name("Segoe UI"),
            weight: iced::font::Weight::Normal,
            stretch: iced::font::Stretch::Normal,
            style: iced::font::Style::Normal,
        },
        FasciaTheme::LinuxDark | FasciaTheme::LinuxLight => Font {
            family: iced::font::Family::Name("Inter"),
            weight: iced::font::Weight::Normal,
            stretch: iced::font::Stretch::Normal,
            style: iced::font::Style::Normal,
        },
        FasciaTheme::VsCodeDark => Font {
...
pub fn default_code_font(theme: FasciaTheme) -> Font {
    match theme {
        FasciaTheme::WindowsDark | FasciaTheme::WindowsLight => Font {
            family: iced::font::Family::Name("Cascadia Code"),
            weight: iced::font::Weight::Normal,
            stretch: iced::font::Stretch::Normal,
            style: iced::font::Style::Normal,
        },

...
pub fn	view_shell< 'a, Message: 'static>( 
    menubar: Element< 'a, Message>, toolbar: Option<Element<'a, Message>>,
    activity_bar: Element< 'a, Message>, sidebar: Option<Element<'a, Message>>,
    content: Element< 'a, Message>, status_bar: Option<Element<'a, Message>>, palette: ThemePalette,
) -> Element< 'a, Message> {
